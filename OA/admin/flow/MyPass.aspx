<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Inherits="OA.admin.flow.Flow_MyPass" Codebehind="MyPass.aspx.cs" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-striped">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="查看">
                            <ItemTemplate>
                                <a href="ArchivesInfo.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>">查看</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
