...
function TreeNode()
{
    ...
    this.Show = function()
    {
        ...
        this.imgPlus = $('<span class="glyphicon glyphicon-search" aria-hidden="true"></span>')
...
var createFileView = function(fileName, isFolder, fileSize, modifyDate)
{
    ...
    inputtd.className= "chkColumn width_3";

    var fileChk = document.createElement("input");
    fileChk.type = "checkbox";
    fileChk.name="checkbox";
    fileChk.title = fileName;
    inputtd.appendChild(fileChk);
    fileItem.appendChild(inputtd);

    var fileType = document.createElement("td");
    fileType.className = "fileType width_13";
    ...
    var fileListName = document.createElement("td");
    fileListName.className = "fileName width_30 ";
    ...
    var fileListSize = document.createElement("td");
    fileListSize.className = "fileSize width_13 ";
    ...
    fileDate.className = "lastUpdate width_26";
    fileDate.innerHTML = modifyDate;
    fileItem.appendChild(fileDate);

    var fileRename = document.createElement("td");
    fileRename.className = "rename width_13 ";
