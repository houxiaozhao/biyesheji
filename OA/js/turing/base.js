/***
 *	TURING Admin JavaScript
 *
 *	http://www.tuling123.com
 *
 *	Copyright © 2012 tuling123.com All Rights Reserved.
 **/
...
function setCookie(name, value) {
	...
	document.cookie = name + "=" + encodeURIComponent(value) + ((expires == null) ? "" : ("; expires=" + expires.toGMTString())) + ";path=" + labsoft.base;
}
