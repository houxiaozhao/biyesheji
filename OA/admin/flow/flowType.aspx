<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Inherits="OA.admin.flow.Flow_flowType" Codebehind="flowType.aspx.cs" %>
        ...
        <div class="row-fluid">
            <div class="panel panel-default">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="table table-hover table-striped"
                    DataKeyNames="ID"  OnRowDeleting="GridView1_RowDeleting" onrowupdating="GridView1_RowUpdating" OnRowEditing="GridView1_RowEditing"
                     >
                   <Columns>
